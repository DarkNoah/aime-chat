...
export enum MastraChannel {
  ...
  EnqueueChatMessage = 'mastra:enqueueChatMessage',
  RequestChatQueueSendNext = 'mastra:requestChatQueueSendNext',
  RemoveChatQueuedMessage = 'mastra:removeChatQueuedMessage',
  GetChatQueueState = 'mastra:getChatQueueState',
