...
export class CodeAgent extends BaseAgent {
  ...
  instructions: DynamicAgentInstructions = ({ requestContext, mastra }) => {
    return {
      role: 'system',
      content: `You are a code agent that helps users with software engineering tasks. Use the instructions below and the tools available to you to assist the user.
